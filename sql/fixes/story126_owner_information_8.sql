...
FROM (select id from catalogue_institution where name='Astrium') as ic_inst, (SELECT
...
WHERE
  ...
  AND catalogue_genericsensorproduct.acquisition_mode_id BETWEEN 4 AND 10) AS aq_mode
