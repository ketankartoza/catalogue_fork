...
FROM (select id from catalogue_institution where name='INPE & CAST') as ic_inst, (SELECT
...
WHERE
  ...
  AND catalogue_genericsensorproduct.acquisition_mode_id IN (12,13,14)) AS aq_mode
