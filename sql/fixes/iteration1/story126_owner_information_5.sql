...
FROM (select id from catalogue_institution where name='USGS') as ic_inst, (SELECT
...
WHERE
  ...
  AND catalogue_genericsensorproduct.acquisition_mode_id BETWEEN 76 AND 81) AS aq_mode
