BEGIN;
create table delete_spot_acquisitionmode AS
SELECT
...
-- condition
  ...
  catalogue_genericsensorproduct.acquisition_mode_id BETWEEN 4 AND 10;

delete from catalogue_opticalproduct using delete_spot_acquisitionmode where genericsensorproduct_ptr_id=delete_spot_acquisitionmode.id;
delete from catalogue_genericsensorproduct using delete_spot_acquisitionmode where genericimageryproduct_ptr_id=delete_spot_acquisitionmode.id;
delete from catalogue_genericimageryproduct using delete_spot_acquisitionmode where genericproduct_ptr_id=delete_spot_acquisitionmode.id;
delete from catalogue_searchrecord using delete_spot_acquisitionmode where catalogue_searchrecord.product_id=delete_spot_acquisitionmode.id;
delete from catalogue_genericproduct using delete_spot_acquisitionmode where catalogue_genericproduct.id=delete_spot_acquisitionmode.id;

--
drop table delete_spot_acquisitionmode;
COMMIT;