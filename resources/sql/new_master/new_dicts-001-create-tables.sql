...
ALTER TABLE "dictionaries_radarproductprofile" ADD CONSTRAINT "satellite_instrument_id_refs_id_802f4869" FOREIGN KEY ("satellite_instrument_id") REFERENCES "dictionaries_satelliteinstrument" ("id") DEFERRABLE INITIALLY DEFERRED;
...
;
ALTER TABLE "dictionaries_opticalproductprofile" ADD CONSTRAINT "spectral_mode_id_refs_id_edc353ef" FOREIGN KEY ("spectral_mode_id") REFERENCES "dictionaries_spectralmode" ("id") DEFERRABLE INITIALLY DEFERRED;
...
;
ALTER TABLE "dictionaries_instrumenttype" ADD CONSTRAINT "reference_system_id_refs_id_f2eb70b9" FOREIGN KEY ("reference_system_id") REFERENCES "dictionaries_referencesystem" ("id") DEFERRABLE INITIALLY DEFERRED;
...
;
ALTER TABLE "dictionaries_spectralmodeprocessingcosts" ADD CONSTRAINT "foreign_currency_id_refs_id_13056b04" FOREIGN KEY ("foreign_currency_id") REFERENCES "dictionaries_foreigncurrency" ("id") DEFERRABLE INITIALLY DEFERRED;
