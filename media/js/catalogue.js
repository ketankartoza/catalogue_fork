...
(function($) {
	...
	_set_dim: function (offset){
	    ...
	    self.options.map.setCenter(center,zoom);
	},

	_create_image:function(arg){
	    var self=this;
	    var resize_handle = $('<div>').attr({
		'id':'map_resize'
	    });
	    resize_handle.css({
		'z-index':99999,
	    ...
	    //resize_handle.append($('<img>').attr({'src':'/media/images/sun.png'}));
