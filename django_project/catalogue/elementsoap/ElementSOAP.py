#
# ElementSOAP
# $Id: ElementSOAP.py 3349 2007-12-24 09:44:54Z fredrik $
#
...
# 2007-12-20 fl   workaround for TG faults (from Florent Aide)
#
...
class SoapService:
    ...
    def call(self, action, request, header=None, debug=False):
