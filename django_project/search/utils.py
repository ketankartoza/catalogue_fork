...
def prepareSelectQuerysets(
    ...
    myCollection_QS = (
        Collection.objects
        .filter(**{(
            'satellite__satelliteinstrumentgroup__satelliteinstrument__'
            'opticalproductprofile__in'): myOPP
        })
    ...
    mySatellite_QS = (
        Satellite.objects
        .filter(**{(
            'satelliteinstrumentgroup__satelliteinstrument__'
            'opticalproductprofile__in'): myOPP
        })
        .distinct().order_by('name')
    )
    ...
    mySpectralGroup_QS = (
        SpectralGroup.objects
        .filter(spectralmode__opticalproductprofile__in=myOPP)
        .distinct().order_by('name')
    )
    ...
    myLicense_QS = (
        License.objects
        .filter(**{(
            'satellite__satelliteinstrumentgroup__satelliteinstrument'
            '__opticalproductprofile__in'): myOPP
        })
        .distinct().order_by('name')
    )
